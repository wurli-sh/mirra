  ...
  return (
    <section className="py-[12vh]">
      <div className="mx-auto max-w-4xl">
        ...
        >
          Fully reactive. No bots. No infrastructure. Just on-chain events doing the work.
        </motion.p>
        ...
        <div className="mt-16 grid gap-5 md:grid-cols-2">
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'radial-gradient(circle, rgba(255, 213, 240, 0.4) 1px, transparent 1px)', backgroundSize: '20px 20px' }}
            />
            <div className="relative z-10">
              <h3 className="text-xl font-bold">Reactive Copy-Trading</h3>
              <p className="mt-3 max-w-xs text-sm leading-relaxed text-white/70">
                Leaders swap, followers mirror — automatically, in one transaction.
              </p>
            </div>
            <div className="relative mt-6 flex items-center justify-center">
              <AnimatedImage
                ...
                className="relative z-10 w-full max-w-sm object-contain drop-shadow-2xl group-hover:scale-[1.03] transition-transform duration-300"
          ...
          >
            <div
              ...
              style={{ backgroundImage: 'radial-gradient(circle, rgba(55, 3, 5, 0.5) 1px, transparent 1px)', backgroundSize: '16px 16px' }}
            />
            ...
            <div className="relative flex justify-end">
              <AnimatedImage
                src={funnelImg}
                alt="Risk Guardian"
                className="relative z-10 h-52 object-contain object-top-right drop-shadow-xl group-hover:scale-[1.03] transition-transform duration-300"
                placeholderClass="h-52 w-full"
              />
            </div>
            <div className="relative z-10 px-6 pb-6">
              <h3 className="text-xl font-bold text-secondary">Risk Guardian</h3>
              <p className="mt-1 text-sm text-text-muted">
                Auto stop-loss on every mirror. Positions close when your threshold is hit.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 px-6 pb-6">
              <h3 className="text-xl font-bold text-secondary">Reputation Scoring</h3>
              <p className="mt-1 text-sm text-text-muted">
                Composite scores from win rate, volume, and recency. Trust the numbers.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <span className="text-sm text-text-muted">
            <span className="font-semibold text-secondary">7 contracts</span> — 2 reactive, 5 regular — powering the full cascade on Somnia Shannon Testnet
          </span>
        </motion.div>
      </div>
    </section>
