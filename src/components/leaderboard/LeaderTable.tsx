  ...
  return (
    <div>
      ...
      <div className="flex items-center bg-surface-alt px-4 py-2.5">
        ...
        <span className="text-xs text-text-faint uppercase tracking-widest font-medium w-[90px] text-center shrink-0">
          Form
        </span>
        <span className="text-xs text-text-faint uppercase tracking-widest font-medium w-[60px] text-center shrink-0">
          Trend
        </span>
      </div>
